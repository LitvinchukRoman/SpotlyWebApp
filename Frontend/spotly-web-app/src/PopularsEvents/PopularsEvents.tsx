  ...
  return (
    <>
      <div className={eventsStyle.popEvents}>
        <div className={eventsStyle.popEvents__wrapper}>
          <div className={cn(eventsStyle.popEvents__top, eventsStyle.popEvents__firstTop)}>
          ...
          <div className={cn(eventsStyle.popEvents__firstCategory, eventsStyle.popEvents__categories)}>
            <div className={eventsStyle.popEvents__singleEvent}>
              <div className={eventsStyle.popEvents__singleEventTop}>
